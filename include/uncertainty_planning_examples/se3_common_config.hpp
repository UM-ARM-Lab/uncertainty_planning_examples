...
namespace se3_common_config
{
    ...
    {
        return config_common::EXTRA_CONFIG_PARAMS(0.125, 10.0, 0.0, 0.125, "peg_in_hole");
    }
    ...
    inline simple_robot_models::SE3_ROBOT_CONFIG GetDefaultRobotConfig(const config_common::EXTRA_CONFIG_PARAMS& options)
    {
    ...
    inline uncertainty_planning_core::SE3SimulatorPtr GetSimulator(const config_common::EXTRA_CONFIG_PARAMS& options, const int32_t debug_level)
    {
        ...
        return fast_kinematic_simulator::MakeSE3Simulator(environment_components.GetEnvironment(), environment_components.GetEnvironmentSDF(), environment_components.GetSurfaceNormalsGrid(), solver_params, options.simulation_controller_frequency, debug_level);
    }
}
